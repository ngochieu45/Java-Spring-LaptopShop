                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="p-3 border rounded">
                                            ...
                                            <!-- Mục đích sử dụng -->
                                            <div class="mb-2 mt-3"><b>Mục đích sử dụng</b></div>
                                            <div class="form-check form-check-inline">
                                            ...
                                            <!-- Mức giá -->
                                            <div class="mb-2 mt-3"><b>Mức giá</b></div>
                                            <div class="form-check form-check-inline">
                                            ...
                                            <!-- Sắp xếp -->
                                            <div class="mb-2 mt-3"><b>Sắp xếp</b></div>
                                            <div class="form-check form-check-inline">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="sort-3"
                                                    value="gia-nothing" checked name="radio-sort">
                                                <label class="form-check-label" for="sort-3">Không sắp xếp</label>
                                            </div>

                                            <!-- Nút lọc -->
                                            <button
                                                class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mt-3 w-100"
                                                id="btnFilter">
                                                Lọc Sản Phẩm
                                            </button>
                                        </div>
                                                    ...
                                                    <div class="rounded position-relative fruite-item">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex flex-lg-wrap justify-content-center">
                                                                <p
                                                                    class="text-dark fs-5 fw-bold mb-0 w-100 text-center">
                                                    ...
                                                    <ul class="pagination d-flex justify-content-center mt-5">
                                                        ...
                                                        <li class="page-item ${currentPage eq 1 ? 'disabled' : ''}">
                                                            <a class="page-link rounded"
                                                                href="/products?page=${currentPage - 1}">&laquo;</a>
                                                        </li>
                                                        <!-- Pages -->
                                                        ...
                                                        <li
                                                            ...
                                                            <a class="page-link rounded"
                                                                href="/products?page=${currentPage + 1}">&raquo;</a>
                                                        </li>
                                                    </ul>
                                                </nav>
                                            </div>
